...
omega designing brainstorming idea document of doom

## Other

## Unsorted

- epub upload for easy import (can be difficult)
- epub download

## Copied from older document
...
site-ui-design
ideas
ideas-forum (rules and limitations)
ideas-forum (public api)
ideas-forum (text formatting)
ideas-forum (user authentication)
ideas-forum (system architecture)
ideas-forum (tag system)
ideas-forum (pink.prose shortlinks and IDs)
ideas-forum (rules)
ideas-forum (images)
ideas-forum (decentralisation)
ideas-forum (user profiles)
ideas-forum (content ownership and control)
rust (???)
-->
